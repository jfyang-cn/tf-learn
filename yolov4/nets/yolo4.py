...
from utils.utils import decode_netout, do_nms, generate_colors, get_boxes, correct_yolo_boxes
...
#     obj_thresh = 0.25
    ...
    for i in range(len(anchors)):
        ...
        boxes += decode_netout(yhat[i], anchors[i], obj_thresh, input_h, input_w, len(anchors), scales_x_y[i])
